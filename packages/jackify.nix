...
in python3.pkgs.buildPythonApplication {
  ...
  src = fetchFromGitHub {
    owner = "Omni-guides";
    repo = "Jackify";
    rev = "33b3fbaed2662ccc1e8fd78ac1df69c17dbc4015";
    hash = "sha256-6fzt9aZOYkcijHb6O3QdKGt1SYyEtmJGLZqWROCHni8=";
  };

  format = "other";

  patches = [ ./nexus-auto-download.patch ];
...
EOF
  ...
  makeWrapperArgs = [
    "--prefix" "LD_LIBRARY_PATH" ":" "${placeholder "out"}/${python3.sitePackages}/jackify/engine"
